  ...
  return (
    <div className="min-h-screen bg-carbon flex items-center justify-center px-4">
      <div className="text-center">
        <p className="text-7xl font-black text-neon/30 mb-4">404</p>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-neon hover:brightness-110 text-carbon font-medium px-5 py-2.5 rounded-lg transition-colors"
        >
