export const metadata = { title: 'Política de privacidad — ApuestaClara' }
...
export default function PrivacidadPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-texto-secundario text-sm leading-relaxed">
        <section>
          <h2 className="text-white font-semibold text-base mb-2">1. Responsable del tratamiento</h2>
          <p>ApuestaClara es responsable del tratamiento de los datos personales recogidos a través de esta plataforma.</p>
        </section>
        ...
        <section>
          ...
          <p>Puedes ejercer tus derechos de acceso, rectificación, supresión y portabilidad contactando en <span className="text-neon">hola@gananesbets.com</span>.</p>
        </section>

        <section>
          <h2 className="text-white font-semibold text-base mb-2">7. Servicios de terceros</h2>
          <ul className="list-disc list-inside space-y-1 text-texto-secundario">
            <li><strong className="text-texto-secundario">Supabase</strong> — base de datos y autenticación</li>
            <li><strong className="text-texto-secundario">Stripe</strong> — procesamiento de pagos</li>
            <li><strong className="text-texto-secundario">Vercel</strong> — alojamiento</li>
            <li><strong className="text-texto-secundario">Groq</strong> — análisis de IA</li>
          </ul>
        </section>
      </div>
    </main>
