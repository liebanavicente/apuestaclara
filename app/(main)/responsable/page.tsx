  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-12">
      ...
      <div className="rounded-xl border border-orange-500/30 bg-orange-500/10 p-6 mb-8">
        <p className="text-orange-300 font-semibold text-lg mb-2">ApuestaClara no es un operador de apuestas</p>
      ...
      <div className="space-y-6">
        {[
          ...
          },
          {
            ...
            body: 'Las apuestas deportivas están prohibidas para menores de 18 años en España. ApuestaClara requiere ser mayor de edad para registrarse.',
          },
        ].map(({ icon, title, body }) => (
          <div key={title} className="rounded-xl border border-neon/10 bg-superficie/80 p-5">
