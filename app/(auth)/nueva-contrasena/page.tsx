            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-neon/10 bg-superficie-hover px-3 py-2.5 text-white placeholder-texto-terciario text-sm focus:border-neon focus:outline-none focus:ring-1 focus:ring-neon/50 pr-10"
                  required minLength={8}
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-texto-terciario hover:text-texto-secundario">
