...
export default async function DebugPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="rounded-xl border border-superficie-hover bg-superficie overflow-hidden mb-8">
      ...
      <div className="rounded-xl border border-superficie-hover bg-superficie overflow-hidden">
        {tableStatus.map(({ table, count, ok, error }) => (
          <div key={table} className="flex justify-between items-center px-4 py-2.5 border-b border-superficie-hover last:border-0">
            <span className="text-texto-secundario text-sm font-mono">{table}</span>
            <div className="flex items-center gap-3">
              <span className="text-texto-secundario text-xs">{count} registros</span>
