      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative">
          <div
            ...
            style={{ background: 'linear-gradient(90deg, #00E676, #FFB300)' }}
          />
            ...
            {STEPS.map((step, i) => (
              <Reveal key={step.title} delay={i * 200}>
                <div className="flex flex-col items-center text-center">
                  <div className="relative z-10 mb-4 flex h-16 w-16 items-center justify-center rounded-full border-2 border-neon bg-[#1E1E1E] text-2xl text-neon">
                    {step.emoji}
                  </div>
                  <div className="relative w-full rounded-2xl border border-[#2A2A2A] bg-[#1E1E1E] p-8">
